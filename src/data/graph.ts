...
export const GRAPH_NODES: Record<string, GraphNode> = {
  // Entrances and Exits
  'entrance': { id: 'entrance', name: 'Supermarket Entrance', x: 0.0, z: 7.4 },
  'exit': { id: 'exit', name: 'Supermarket Exit', x: -5.0, z: 7.4 },
  'billing': { id: 'billing', name: 'Billing Counter', x: -3.5, z: 6.0 },

  // Front Perimeter Aisle Intersections
  'front_left': { id: 'front_left', name: 'Front-Left Aisle', x: -5.8, z: 5.0 },
  'front_center': { id: 'front_center', name: 'Front-Center Aisle', x: 0.0, z: 5.0 },
  'front_right': { id: 'front_right', name: 'Front-Right Aisle', x: 5.8, z: 5.0 },

  // Mid-Front (B-C Horizontal Aisle) Intersections
  'mid_front_left': { id: 'mid_front_left', name: 'Mid-Front Left Aisle', x: -5.8, z: 1.0 },
  'mid_front_center': { id: 'mid_front_center', name: 'Center Crossroad (Aisle B-C)', x: 0.0, z: 1.0 },
  'mid_front_right': { id: 'mid_front_right', name: 'Mid-Front Right Aisle', x: 5.8, z: 1.0 },

  // Mid-Rear (A-B Horizontal Aisle) Intersections
  'mid_rear_left': { id: 'mid_rear_left', name: 'Mid-Rear Left Aisle', x: -5.8, z: -3.0 },
  'mid_rear_center': { id: 'mid_rear_center', name: 'Center Crossroad (Aisle A-B)', x: 0.0, z: -3.0 },
  'mid_rear_right': { id: 'mid_rear_right', name: 'Mid-Rear Right Aisle', x: 5.8, z: -3.0 },

  // Rear Perimeter Aisle Intersections
  'rear_left': { id: 'rear_left', name: 'Rear-Left Aisle', x: -5.8, z: -6.4 },
  'rear_center': { id: 'rear_center', name: 'Rear-Center Aisle', x: 0.0, z: -6.4 },
  'rear_right': { id: 'rear_right', name: 'Rear-Right Aisle', x: 5.8, z: -6.4 },

  // Rack Access Points
  // Rack A1 (Fruits) & A2 (Vegetables)
  'rack_A1_rear': { id: 'rack_A1_rear', name: 'Fruits Shelf Access (Rear Aisle)', x: -3.5, z: -6.4 },
  'rack_A1_front': { id: 'rack_A1_front', name: 'Fruits Shelf Access (Aisle A-B)', x: -3.5, z: -3.0 },
  'rack_A2_rear': { id: 'rack_A2_rear', name: 'Vegetables Shelf Access (Rear Aisle)', x: 3.5, z: -6.4 },
  'rack_A2_front': { id: 'rack_A2_front', name: 'Vegetables Shelf Access (Aisle A-B)', x: 3.5, z: -3.0 },

  // Rack B1 (Dairy) & B2 (Bakery)
  'rack_B1_rear': { id: 'rack_B1_rear', name: 'Dairy Shelf Access (Aisle A-B)', x: -3.5, z: -3.0 },
  'rack_B1_front': { id: 'rack_B1_front', name: 'Dairy Shelf Access (Aisle B-C)', x: -3.5, z: 1.0 },
  'rack_B2_rear': { id: 'rack_B2_rear', name: 'Bakery Shelf Access (Aisle A-B)', x: 3.5, z: -3.0 },
  'rack_B2_front': { id: 'rack_B2_front', name: 'Bakery Shelf Access (Aisle B-C)', x: 3.5, z: 1.0 },

  // Rack C1 (Snacks) & C2 (Beverages)
  'rack_C1_rear': { id: 'rack_C1_rear', name: 'Snacks Shelf Access (Aisle B-C)', x: -3.5, z: 1.0 },
  'rack_C1_front': { id: 'rack_C1_front', name: 'Snacks Shelf Access (Front Aisle)', x: -3.5, z: 5.0 },
  'rack_C2_rear': { id: 'rack_C2_rear', name: 'Beverages Shelf Access (Aisle B-C)', x: 3.5, z: 1.0 },
  'rack_C2_front': { id: 'rack_C2_front', name: 'Beverages Shelf Access (Front Aisle)', x: 3.5, z: 5.0 },
};
